...
func (c *healthClient) Check(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CheckResponse, error) {
...
func (UnimplementedHealthServer) Check(context.Context, *emptypb.Empty) (*CheckResponse, error) {
